...
function renderPageContent(page) {
  ...
  if (page.type === "assistant") {
    return `<div class="page_content assistant" style="position:relative;min-height:calc(var(--vh, 1vh)*100);box-sizing:border-box;overflow:hidden;"><div class="assistant-hero"><div class="assistant-hero__prompt" aria-hidden="true"><span>Ask about my work</span><span>Ask about my projects</span><span>Ask about my experience</span><span>Ask about infrastructure</span></div><form class="assistant-hero__form" action="/assistant-widget/" method="get"><input name="q" type="text" autocomplete="off" placeholder="Ask about my work, projects, or experience" aria-label="Ask assistant" /></form></div><style>.assistant-hero{position:absolute;right:clamp(72px,6vw,96px);bottom:clamp(64px,5.5vw,88px);width:clamp(340px,34vw,420px);max-width:calc(100% - 2.2rem);display:grid;gap:12px;align-items:start;justify-items:start}.assistant-hero__prompt{position:relative;height:1.42em;line-height:1.2;display:block;overflow:hidden}.assistant-hero__prompt span{position:absolute;left:0;top:0;display:block;width:0;opacity:0;overflow:hidden;white-space:nowrap;color:rgba(243,243,243,.84);font-size:clamp(16px,1.38vw,21px);font-weight:360;letter-spacing:.016em;border-right:1px solid rgba(230,230,230,.42);padding-right:.22ch;animation:assistantTypeCycle 16s steps(30,end) infinite}.assistant-hero__prompt span:nth-child(2){animation-delay:4s}.assistant-hero__prompt span:nth-child(3){animation-delay:8s}.assistant-hero__prompt span:nth-child(4){animation-delay:12s}.assistant-hero__form{display:block;width:100%}.assistant-hero__form input{width:100%;height:50px;box-sizing:border-box;background:rgba(8,8,8,.22);color:rgba(248,248,248,.93);border:1px solid rgba(210,210,210,.24);border-radius:8px;padding:0 .88rem;font:inherit;font-size:15px;letter-spacing:.004em;outline:none;backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);transition:border-color .28s ease,box-shadow .28s ease,background-color .28s ease}.assistant-hero__form input::placeholder{color:rgba(226,226,226,.5)}.assistant-hero__form input:focus{border-color:rgba(244,244,244,.48);box-shadow:0 0 0 1px rgba(255,255,255,.06),0 8px 20px rgba(255,255,255,.035);background:rgba(10,10,10,.28)}@media (max-width:980px){.assistant-hero{right:clamp(20px,5vw,30px);bottom:clamp(28px,8vw,48px);width:min(92vw,360px);gap:10px}.assistant-hero__prompt span{font-size:clamp(14px,4vw,18px)}.assistant-hero__form input{height:46px;font-size:14px;padding:0 .72rem}}@keyframes assistantTypeCycle{0%{opacity:0;width:0}4%{opacity:1;width:0}20%{opacity:1;width:100%}28%{opacity:1;width:100%}32%{opacity:0;width:100%}100%{opacity:0;width:0}}</style></div>`;
  }
