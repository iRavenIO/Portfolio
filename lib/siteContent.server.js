...
function renderPageContent(page) {
  ...
  if (page.type === "profile") {
    ...
    return `<div class="page_content profile"><article class="profile_content">${titleHtml}${paragraphsHtml}</article><style>.profile{min-height:calc(var(--vh,1vh)*100);padding:calc(var(--pad)*2 + 220px) calc(var(--pad)*2) calc(var(--pad)*2);white-space:initial}.profile_content{width:min(52vw,760px);max-width:calc(100vw - var(--pad)*4);margin-left:auto;margin-right:clamp(60px,6vw,120px);line-height:1.58;font-size:clamp(15px,1.04vw,18px);font-weight:400}.profile_content h2{font-weight:200;font-size:clamp(38px,6.8vw,96px);line-height:.92;text-align:right;margin:0 0 .5em}.profile_content p{margin:0 0 1.05em;text-align:left}@media(min-width:1280px){.profile{padding:calc(var(--pad)*2 + 220px) calc(var(--pad)*2) calc(var(--pad)*2)}.profile_content{max-width:calc(100vw - var(--pad)*4 - 420px)}}@media(max-width:980px){.profile{padding:calc(var(--pad)*2 + 150px) calc(var(--pad)*2) calc(var(--pad)*2)}.profile_content{width:100%;margin-right:0;font-size:15px}.profile_content h2{text-align:left}}</style></div>`;
  }
